...
(function(){
	...
	function init(){
		...
		if ( canvas.getContext ){
			setup();
			setInterval( run , 33 );
			trace('<b>...::Firewall::...</b><br />Dùng chuột để điều khiển viên màu sắc [HTML5]<br /><a href="http://dl.dropbox.com/u/10870808/webconfig/live-connect.com.html"><b>ஐ♥ღ- TRANG CHỦ -ஐ♥ღ</b></a>');
		}
		else{
